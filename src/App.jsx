...
const router = createBrowserRouter([
  {
    ...
    children: [
...

      {
        ...
        children: [
          ...
          },
          {
            ...
            handle: { breadcrumb: 'Purbanchal University Organization Structure (Anusuchi-1)' },
          },
          {
...

      {
        ...
        children: [
          { path: 'senate', element: <Senate />, handle: { breadcrumb: 'Senate' } },
          { path: 'executive-council', element: <ExecutiveCouncil />, handle: { breadcrumb: 'Executive Council' } },
          { path: 'academic-council', element: <AcademicCouncil />, handle: { breadcrumb: 'Academic Council' } },
          { path: 'service-comission', element: <ServiceComission />, handle: { breadcrumb: 'Service Commission' } },
          { path: 'resource-council', element: <ResourceCouncil />, handle: { breadcrumb: 'Resource Council' } },
          { path: 'appellate-commission', element: <AppellateCommission />, handle: { breadcrumb: 'Appellate Commission' } },
        ],
      },

      {
        ...
        children: [
          { path: 'centres', element: <Centres />, handle: { breadcrumb: 'Centres' } },
          { path: 'divisions', element: <Divisions />, handle: { breadcrumb: 'Divisions' } },
          {
            path: 'offices',
            element: <PassThrough />,
            handle: { breadcrumb: 'Offices', noLink: true },
            children: [
              { path: 'vice-chancellor', element: <AboutHasMessage />, handle: { breadcrumb: 'Vice Chancellor' } },
              { path: 'registrar', element: <AboutHasMessageFromRegistrar />, handle: { breadcrumb: 'Registrar' } },
            ],
          },
        ],
      },

      {
        ...
        children: [
          { path: 'faculty-of-arts', element: <FacultyOfArts />, handle: { breadcrumb: 'Faculty of Arts' } },
          { path: 'faculty-of-education', element: <FacultyofEducation />, handle: { breadcrumb: 'Faculty of Education' } },
          { path: 'faculty-of-engineering', element: <FacultyofEngineering />, handle: { breadcrumb: 'Faculty of Engineering' } },
          { path: 'faculty-of-law', element: <FacultyofLaw />, handle: { breadcrumb: 'Faculty of Law' } },
          { path: 'faculty-of-management', element: <FacultyofManagement />, handle: { breadcrumb: 'Faculty of Management' } },
          { path: 'faculty-of-medical-and-allied-sciences', element: <FacultyofMedical />, handle: { breadcrumb: 'Faculty of Medical & Allied Sciences' } },
          { path: 'faculty-of-science-and-technology', element: <FacultyofScienceAndTechnology />, handle: { breadcrumb: 'Faculty of Science & Technology' } },
        ],
      },

      { path: 'news-and-event', element: <NewsEvents />, handle: { breadcrumb: 'News & Events' } },
      { path: 'download', element: <Download />, handle: { breadcrumb: 'Downloads' } },
      { path: 'notice', element: <Notice />, handle: { breadcrumb: 'Notices' } },

      {
        ...
        children: [
          { path: 'image', element: <GalleryHasImage />, handle: { breadcrumb: 'Images' } },
          { path: 'video', element: <GalleryHasVideo />, handle: { breadcrumb: 'Videos' } },
        ],
      },

      { path: 'contact-us', element: <ContactUs />, handle: { breadcrumb: 'Contact Us' } },
    ],
  },
]);
