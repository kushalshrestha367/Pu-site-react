...
const subject = () => nom(`${D}, विषय समिति`);
const blank = () => nom(`${D},`);
...
const sections = [
  ...
  {
    t: "पूर्वाञ्चल विश्वविद्यालय ऐन, २०५० को दफा १० को उपदफा (१) को खण्ड (ख) बमोजिम",
    r: [["डा. रमेशबाबु काफ्ले, रजिष्ट्रार", "सदस्य", "पदेन"]],
  },
  {
    t: "पूर्वाञ्चल विश्वविद्यालय ऐन, २०५० को दफा १० को उपदफा (१) को खण्ड (ग) बमोजिम डीनहरू",
    r: [
  ...
  {
    t: "पूर्वाञ्चल विश्वविद्यालय ऐन, २०५० को दफा १० को उपदफा (१) को खण्ड (घ) बमोजिम (विश्वविद्यालयका विभिन्न विषय समितिका अध्यक्षहरू मध्येबाट पाँच जना)",
    r: [
      subject(),
      nom(`${vacant}, अध्यक्ष, ................. विषय समिति`),
      subject(),
      subject(),
      subject(),
    ],
  ...
  {
    t: "पूर्वाञ्चल विश्वविद्यालय ऐन, २०५० को दफा १० को उपदफा (१) को खण्ड (ङ) बमोजिम",
    r: [
      [
        `${vacant}, प्रमुख, पाठ्यक्रम अनुसन्धान तथा विकास केन्द्र`,
        "सदस्य",
        "पदेन",
      ],
    ],
  ...
  {
    t: "पूर्वाञ्चल विश्वविद्यालय ऐन, २०५० को दफा १० को उपदफा (१) को खण्ड (च) बमोजिम (विश्वविद्यालय अनुसन्धान महाशाखा, योजना महाशाखा र समन्वय महाशाखाका प्रमुखहरू)",
    r: [
      [`${vacant}, प्रमुख, अनुसन्धान केन्द्र`, "सदस्य", "पदेन"],
      [`${vacant}, प्रमुख, योजना महाशाखा`, "सदस्य", "पदेन"],
      [`${vacant}, प्रमुख, समन्वय महाशाखा`, "सदस्य", "पदेन"],
    ],
  },
  {
    t: "पूर्वाञ्चल विश्वविद्यालय ऐन, २०५० को दफा १० को उपदफा (१) को खण्ड (छ) बमोजिम (वरिष्ठ प्राध्यापकहरू मध्येबाट दुई जना)",
    r: [blank(), blank()],
  },
  {
    t: "पूर्वाञ्चल विश्वविद्यालय ऐन, २०५० को दफा १० को उपदफा (१) को खण्ड (ज) बमोजिम (क्याम्पस प्रमुखहरू मध्येबाट चार जना)",
    r: [
      nom(`${vacant}, क्याम्पस प्रमुख/डाइरेक्टर आंगिक क्याम्पस`),
      blank(),
      blank(),
      blank(),
    ],
  ...
  {
    t: "पूर्वाञ्चल विश्वविद्यालय ऐन, २०५० को दफा १० को उपदफा (१) को खण्ड (झ) बमोजिम (लब्ध प्रतिष्ठित विद्वानहरू मध्येबाट दुई जना)",
    r: [blank(), blank()],
  },
  {
    t: "पूर्वाञ्चल विश्वविद्यालय ऐन, २०५० को दफा १० को उपदफा (१) को खण्ड (ञ) बमोजिम (डीनहरू मध्येबाट उप–कुलपतिले तोकेको व्यक्ति)",
    r: [[D, "सदस्य–सचिव", "पदेन"]],
  },
];

const intro =
  "पूर्वाञ्चल विश्वविद्यालय ऐन, २०५० को दफा १० बमोजिम विश्वविद्यालयको शैक्षिक तथा प्राज्ञिक निकायको रूपमा काम गर्न देहायका सदस्यहरू भएको एक प्राज्ञिक परिषद्को गठन हुनेछः–";

const note =
  "द्रष्टव्यः ऐनको व्यवस्था अनुसार पदेन सदस्यहरू बाहेक अन्य सदस्यहरूको मनोनयन कार्यकारी परिषद्को सिफारिशमा कुलपतिबाट हुनेछ । मनोनीत सदस्यहरूको पदावधि तीन वर्षको हुनेछ ।";
              ...
              <thead className="sticky top-0 z-20">
                <tr className="bg-[#252659] text-left text-white">
                  ...
                  <th className="px-4 py-4 text-xs font-semibold uppercase tracking-wider lg:text-sm">
                    प्राज्ञिक परिषद्का पदाधिकारीहरू
                  </th>
