...
export default function AboutHasInfrastructurePlans() {
    ...
    <section className="relative flex min-h-[70vh] w-full items-center bg-white py-16 sm:py-20">
      ...
      <div className="relative z-10 mx-auto w-full max-w-6xl px-6 sm:px-8 lg:px-12">
        ...
        <motion.p
          ...
          className="mt-6 max-w-md text-[14.5px] leading-[1.8] text-slate-600 sm:text-[15px] text-justify"
        >
          We are currently preparing detailed information about the
          infrastructure plans of Purbanchal University. Please check back soon
          for updates on upcoming developments, facilities, and future expansion
          projects.
        </motion.p>
        <motion.div
          initial={reduce ? false : { opacity: 0, y: 14 }}
