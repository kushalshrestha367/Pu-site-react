...
const colleges = [
  {
    ...
    programs: "BBA-105, MBA (Spring/Fall)-33/33, M.Phil.-16, Ph.D.",
  },
  {
    sn: 2,
    name: "Karfok Bidya Mandir Multiple Campus",
    address: "Suryodaya, Ilam",
    programs: "BBS-60, BBA-48",
  },
  {
    sn: 3,
    name: "Gomendra Multiple College",
    address: "Birtamode, Jhapa",
    programs: "BBA-96, BBS-60, MBA (Fall)-33",
  },
  {
    sn: 4,
    name: "South Asian School of Tourism & Hotel Management",
    address: "Biratnagar, Morang",
    programs: "BBA-144, BHM-144, MBA (Fall)-33, MHHM (Fall)-33",
  },
  {
    sn: 5,
    name: "Zenith International College",
    address: "Biratnagar, Morang",
    programs: "BBA-144, MBA (Spring/Fall)-33/33",
  },
  {
    sn: 6,
  ...
  {
    sn: 13,
    name: "Kshitiz Educational Foundation",
  ...
  },
  {
    ...
    address: "Rajbiraj, Saptari",
    programs: "BBA-96, MBA (Fall)-33",
  },
  {
    sn: 16,
    name: "Annapurna Multiple Campus",
  ...
  {
    sn: 21,
    name: "Janaki College of Management Pvt. Ltd.",
  ...
  },
  {
    ...
    address: "Janakpur, Dhanusha",
    programs: "BBA-144, MBA (Spring)-33",
  },
  {
    sn: 23,
    name: "Central Management College",
    address: "Janakpur, Dhanusha",
    programs: "BBA-96, MBA (Spring)-33",
  },
  {
    sn: 24,
  ...
  {
    sn: 27,
    name: "Lumbini Adarsh Degree College",
    address: "Kawasoti, Nawalparasi",
    programs: "BBS-120, BBA-48",
  },
  {
    sn: 28,
    name: "Shreenagar Integrated College",
    address: "Kapilbastu",
    programs: "BBA-96",
  },
  {
  ...
  },
  {
    ...
    programs: "BBA-48, MBA (Spring/Fall)-33",
  },
  {
    sn: 32,
    name: "Aryan College of Management",
    address: "Kathmandu",
    programs: "BBA-48",
  },
  {
    ...
    address: "Kathmandu",
    programs: "BBA-96, MBA (Fall/Spring)-33/33",
  },
  {
    sn: 34,
  ...
  },
  {
    ...
    address: "Kathmandu",
    programs: "BHM-96, MHHM-33",
  },
  {
    sn: 36,
    name: "D.A.V. Business School",
    address: "Kathmandu",
    programs: "MBA (Spring/Fall)-33/33",
  },
  {
    sn: 37,
    name: "Himalayan Whitehouse Int'l College",
    address: "Kathmandu",
    programs: "BBA-144, BHM-144, MBA (Spring/Fall)-33/33, EMBA-30",
  },
  {
    sn: 38,
  ...
  },
  {
    ...
    address: "Kathmandu",
    programs: "BBA-144, MBA (Spring/Fall)-33/33, EMBA (Spring/Fall)-30/30",
  },
  {
    sn: 40,
    name: "Kantipur International College",
    address: "Kathmandu",
    programs: "BBA-96, BHM-192, BHCM-192, MHHM-33, MBA (Fall/Spring)-33/33",
  },
  {
    sn: 41,
    name: "Kantipur Valley College",
    address: "Kumaripati, Lalitpur",
    programs: "BBA-96, MBA (Fall/Spring)-33/33, EMBA (Fall/Spring)-30/30",
  },
  {
    sn: 42,
    name: "Kasthamandap School of Public Affair Management",
    address: "Kathmandu",
    programs: "MPA (Spring/Fall)-30/30",
  },
  {
    sn: 43,
    name: "Kasthamandap College of Management",
    address: "Kathmandu",
    programs: "BBA-144, MBA (Fall/Spring)-33/33",
  },
  {
    sn: 44,
    name: "Kathmandu Academy of Tourism and Hospitality",
    address: "Kathmandu",
    programs: "BTTS-40, MTS-30",
  },
  {
    sn: 45,
    name: "MAN, Management Development Campus",
    address: "Kathmandu",
    programs: "EMBA-30",
  },
  {
    ...
    address: "Kathmandu",
    programs: "BBA-48, BHM-48, MBA (Fall)-33",
  },
  {
    sn: 47,
  ...
  },
  {
    ...
    address: "Kathmandu",
    programs: "BBA-192, BHM-96, MBA (Fall)-33",
  },
  {
    sn: 52,
    name: "Bageswori College of Management",
  ...
  {
    sn: 55,
    name: "Mega Valley College",
    address: "Lalitpur",
    programs: "BBA-48",
  },
  {
    sn: 56,
    name: "Sahid Aakash Memorial Campus",
    address: "Hetauda, Makawanpur",
    programs: "BBA-48",
  },
  {
    sn: 57,
    name: "Lamahi Samudayik Bigyantatha Prabidhi Sansthan",
    address: "Lamahi, Dang",
    programs: "BBA-48",
  },
  {
  ...
  {
    sn: 61,
    name: "St. Paul's College Sunsary Pvt. Ltd.",
    address: "Duhabi-3, Sunsary",
    programs: "BBS-60",
  },
  {
    sn: 62,
    name: "Nobel Multiple College Bardibas",
    address: "Bardibas-14, Mahottari",
    programs: "BBA-48",
  },
  {
    sn: 63,
    name: "Lions International College Pvt. Ltd.",
    address: "Hetauda, Makawanpur",
    programs: "BBA-48",
  },
  {
