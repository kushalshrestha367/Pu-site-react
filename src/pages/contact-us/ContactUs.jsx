  ...
  return (
    <section className="relative w-full bg-white py-12 sm:py-16 lg:py-20">
      ...
      <div className="relative z-10 mx-auto max-w-6xl px-5 sm:px-8">
        <motion.header {...reveal()} className="mb-12 max-w-3xl sm:mb-16">
          ...
          <p className="mt-4 max-w-2xl text-[14px] leading-relaxed text-slate-600 sm:text-[15px]">
            Reach out to Purbanchal University's Central Office — we're here to
            help with admissions, academics, and administrative queries.
          </p>
        </motion.header>
                ...
                return (
                  <Wrapper
                    ...
                    className={`group flex items-start gap-4 py-5 ${
                      item.href ? "transition-colors hover:bg-slate-50/60" : ""
                    }`}
                  >
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="mt-1.5 text-[14.5px] font-semibold leading-snug text-slate-900 sm:text-[15px]">
                  Regarding academic certificates, verifications, and all other
