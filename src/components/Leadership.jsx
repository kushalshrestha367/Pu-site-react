  ...
  return (
    <section id="leadership-split-cards" className="section bg-gray-50 py-16">
      <div className="container-x grid lg:grid-cols-2 gap-6">
        {cards.map((c, i) => (
          <Reveal key={i} delay={i} className="bg-white rounded-3xl shadow-sm p-6 flex flex-col justify-between h-full">
            <div className="flex flex-col sm:flex-row gap-6">
              ...
              <div className="min-w-0">
                <div
                  className="inline-block bg-puRed text-white text-xs uppercase px-3 py-2 tracking-wider font-bold mb-3"
                >
                  {c.badge}
                </div>
                <h3 className="text-2xl font-bold text-puDark mb-3 font-heading">{c.title}</h3>
